...
class Bookwize_Form_Admin
{
    ...
    public function enqueue_styles()
    {
        ...
        wp_enqueue_style($this->bookwize_form, plugin_dir_url(__FILE__) . '/admin/css/bookwize-form-admin.css', array(), $this->version, 'all');
    }
    ...
    public function enqueue_scripts()
    {
        ...
        wp_enqueue_script($this->bookwize_form, plugin_dir_url(__FILE__) . '/js/bookwize-form-admin.js', array(), $this->version, true);
