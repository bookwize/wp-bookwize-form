...
class Bookwize_Form_Public
{
    ...
    public function enqueue_styles()
    {
        ...
        if (get_option('bwf_disable_css') !== '1') {
            wp_enqueue_style($this->bookwize_form, plugin_dir_url(__FILE__) . 'css/' . get_option('bwf_theme') . '.css', array(), $this->version, 'all');
        }
    }
    ...
    public function enqueue_scripts()
    {
        ...
        wp_enqueue_script($this->bookwize_form . '-app', plugin_dir_url(__FILE__) . 'js/bookwize-form-public.js', array(), $this->version, true);
    }
